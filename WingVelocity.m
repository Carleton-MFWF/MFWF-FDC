...
% wp-Wing planform; 
 ...
 %Iyy =
 %Izz = 
 % I_B = [Ixx Iyy Izz]     % Moment of inertia of body frame in the X, Y and Z axes
...
% Velocity due to rigid body translation
 ...
 Vb =[ ]                  % Linear velocity of rigid body in body frame (should be constantly changing)- as an input
...
Vw = V_r + V_t + V_f;                 % Free stream velocity over an incremental area of wing planform (Addition of FINAL 1 to 3) 
