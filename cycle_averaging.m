...
%A_RW,A_LW is wing beat amplitudes (constant).
...
%J_1 is struve function of order 1.
%H_1 is Bessel function of order 1.
...
Y_RW = -k_D * A_LW * J_1 * (A_LW) * omega_RW * (omega_RW - delta_RW) * sin(eta_RW) * 0.5 + k_D * omega_RW * (omega)